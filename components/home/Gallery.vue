<template>
    <section id="gallery" class="pt-24 pb-12 bg-pink-100">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center flex-col lg:flex-row">
                <div class="w-full lg:w-1/2">
                    <h2 class="font-manrope text-5xl text-center font-bold text-gray-900">Galeri</h2>
                </div>
                <div class="w-full lg:w-1/2 lg:mt-0 md:mt-40 mt-10 max-lg:max-w-2xl">
                    <div class="grid grid-cols-3 min-[450px]:grid-cols-2 md:grid-cols-3 gap-8">
                        <img src="../../assets/images/gallery/gallery_1.jpeg" alt="Team tailwind section"
                            class="w-44 h-56 rounded-2xl object-cover mt-6 md:mt-20 mx-auto min-[450px]:mr-0" />
                        <img src="../../assets/images/gallery/gallery_2.jpeg" alt="Team tailwind section"
                            class="w-44 h-56 rounded-2xl object-cover mx-auto min-[450px]:ml-0 md:mx-auto" />
                        <img src="../../assets/images/gallery/gallery_3.jpeg" alt="Team tailwind section"
                            class="w-44 h-56 rounded-2xl object-cover mt-6 md:mt-20 mx-auto min-[450px]:mr-0 md:ml-0" />
                        <img src="../../assets/images/gallery/gallery_4.jpeg" alt="Team tailwind section"
                            class="w-44 h-56 rounded-2xl object-cover mx-auto min-[450px]:ml-0 md:mr-0 md:ml-auto" />
                        <img src="../../assets/images/gallery/gallery_5.jpeg" alt="Team tailwind section"
                            class="w-44 h-56 rounded-2xl object-cover md:-mt-20 mx-auto min-[450px]:mr-0 md:mx-auto" />
                        <img src="../../assets/images/gallery/gallery_6.jpeg" alt="Team tailwind section"
